...
const FOLLOWUP =
  /^(why|elaborate|tell me more|more|continue|go on|and|so|what else|what do you mean|what committee|which committee|who decided that|prove it|explain|really|sure|hmm+|oh|yeah|and then|then what|sounds fake|source|facts|lol why|seriously)[\s?.!]{0,10}$/i;
